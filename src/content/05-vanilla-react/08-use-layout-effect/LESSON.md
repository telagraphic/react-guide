...
1. **`/labs/vanilla-react/lesson-08`**
2. `npx --yes serve src/content/05-vanilla-react/08-use-layout-effect`

### Supporting files

- [`layout-effect-vanilla.js`](./layout-effect-vanilla.js) · [`index.html`](./index.html)
