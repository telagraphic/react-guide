...
1. **Dev app:** open **`/labs/vanilla-react/lesson-03`** — imports [`use-ref-vanilla.js`](./use-ref-vanilla.js) (keep aligned with the **Vanilla implementation** block below).
2. **Static only:** `npx --yes serve src/content/05-vanilla-react/03-use-ref`, then open [`index.html`](./index.html).

### Supporting files in this folder

- **[`use-ref-vanilla.js`](./use-ref-vanilla.js)** — same logic as the fenced block, as an ES module for the lab route.
