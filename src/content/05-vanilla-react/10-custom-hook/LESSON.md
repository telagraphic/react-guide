...
1. **`/labs/vanilla-react/lesson-10`**
2. `npx --yes serve src/content/05-vanilla-react/10-custom-hook`

### Supporting files

- [`custom-hook-vanilla.js`](./custom-hook-vanilla.js) · [`index.html`](./index.html)
