...
1. **`/labs/vanilla-react/lesson-09`**
2. `npx --yes serve src/content/05-vanilla-react/09-use-effect-event`

### Supporting files

- [`effect-event-vanilla.js`](./effect-event-vanilla.js) · [`index.html`](./index.html)
