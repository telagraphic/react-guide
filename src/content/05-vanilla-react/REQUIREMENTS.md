...
- Each slice lives in its **own folder** next to `mini-react/` (e.g. `01-instance-and-useState/`) with `LESSON.md` plus optional runnable `.js` / `index.html`.
...
## 6. “Breaks for learning” (document in each slice’s `LESSON.md`)
...
```text
src/content/05-vanilla-react/
  README.md
  REQUIREMENTS.md      ← this file
  01-instance-and-useState/   ← Phase 1 slice: prose + fenced code
    LESSON.md
    use-state-vanilla.js      ← importable by Vite lab route (keep in sync with LESSON.md)
    use-state-vanilla.d.ts
    index.html                ← optional static serve
  02-use-effect/
    LESSON.md
    use-effect-vanilla.js
    use-effect-vanilla.d.ts
    index.html
  03-use-ref/
    LESSON.md
    use-ref-vanilla.js
    use-ref-vanilla.d.ts
    index.html
  04-create-context/
    LESSON.md
    create-context-vanilla.js
    create-context-vanilla.d.ts
    index.html
  05-use-reducer/
    LESSON.md
    use-reducer-vanilla.js
    use-reducer-vanilla.d.ts
    index.html
  06-use-memo-callback/
    LESSON.md
    memo-callback-vanilla.js
    memo-callback-vanilla.d.ts
    index.html
  07-use-sync-external-store/
    LESSON.md
    sync-external-store-vanilla.js
    sync-external-store-vanilla.d.ts
    index.html
  08-use-layout-effect/
    LESSON.md
    layout-effect-vanilla.js
    layout-effect-vanilla.d.ts
    index.html
  09-use-effect-event/
    LESSON.md
    effect-event-vanilla.js
    effect-event-vanilla.d.ts
    index.html
  10-custom-hook/
    LESSON.md
    custom-hook-vanilla.js
    custom-hook-vanilla.d.ts
    index.html
  mini-react/            ← Phase 2: TSX kernel + todo + appendix examples
```

Boundary rule: **do not import** real `react` / `react-dom` from `mini-react` lesson code. The Vite app may mount plain lesson bundles via dedicated routes (e.g. `/labs/vanilla-react/lesson-01` … `lesson-10`) that wrap DOM hosts only.
...
- Additional lab routes for new slices — follow the `labs/vanilla-react/lesson-NN` pattern in `src/app/router.tsx` (see lessons **01–10**).
