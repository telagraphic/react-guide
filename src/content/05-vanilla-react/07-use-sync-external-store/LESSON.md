...
1. **`/labs/vanilla-react/lesson-07`**
2. `npx --yes serve src/content/05-vanilla-react/07-use-sync-external-store`

### Supporting files

- [`sync-external-store-vanilla.js`](./sync-external-store-vanilla.js) · [`index.html`](./index.html)
